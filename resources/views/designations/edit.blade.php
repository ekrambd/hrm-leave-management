 ...
 <main class="app-main">
  <div class="app-content-header">
    ...
    <div class="container-fluid">
      <!--begin::Row-->
      <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Edit Designation</h3></div>
        <div class="col-sm-6">
       ...
       <div class="container-fluid">
         <!--begin::Row-->
          <div class="row g-4">
            <div class="col-md-12">
             <div class="card">
               <div class="card-header bg-success text-light"><div class="card-title">Edit Designation</div></div>
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-control select2bs4" name="department_id" id="department_id" required>
                    	...
                    	@foreach(departments() as $department)
                    	 <option value="{{$department->id}}" <?php if($department->id == $designation->department_id){echo "selected";} ?>>{{$department->department_name}}</option>
                    	@endforeach
                    </select>
                    @error('department_id')
                      <p class="alert alert-danger">{{ $message }}</p>
